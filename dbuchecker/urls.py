...
urlpatterns = [
    ...
    path('admin_controller/',showing_app.views.admin_controller,name='admin_controller'),
    path('admin_controller/after_login',showing_app.views.admin_after_login,name='admin_after_login'),
    path('admin_logout/',showing_app.views.admin_logout,name="admin_logout"),
